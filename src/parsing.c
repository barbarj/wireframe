...
/*   Updated: 2018/03/16 00:36:13 by rhallste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static f_fdfd_point3d	*get_line(int fd, unsigned int *width, int line_index)
{
	char			*line;
